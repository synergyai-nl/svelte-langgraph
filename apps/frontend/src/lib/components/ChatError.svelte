...
<div
	class="flex min-h-screen flex-col items-center justify-center bg-white px-6 py-12 dark:bg-black"
>
	<div class="max-w-md text-center">
		<h1 class="mb-4 text-5xl font-light text-gray-900 dark:text-white">
			{error.name}
		</h1>
